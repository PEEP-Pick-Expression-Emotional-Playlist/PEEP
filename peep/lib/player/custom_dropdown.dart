...
///  * RaisedButton(deprecated), FlatButton(deprecated), ordinary buttons that trigger a single action.
...
class _DropdownButtonState<T> extends State<DropdownButton<T>> with WidgetsBindingObserver {
  ...
  void _handleTap() {
    ...
    final EdgeInsetsGeometry menuMargin = ButtonTheme.of(context).alignedDropdown
        ? _kAlignedMenuMargin.add(EdgeInsets.all(1.0))
        : _kUnalignedMenuMargin;

    final List<_MenuItem<T>> menuItems = List<_MenuItem<T>>.filled(widget.items.length,null);
